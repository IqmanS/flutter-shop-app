...
class Orders with ChangeNotifier {
  ...
  Future<void> addOrder(
      List<CartItem> cartProducts, double total, String authToken) async {
    final url = Uri.parse(
        "https://flutter-shop-app-6ea2d-default-rtdb.asia-southeast1.firebasedatabase.app/orders.json?auth=$authToken");
    final prod = [];
